    ...
    <div className="flex flex-col items-center w-full p-4 ">
      ...
      <div className="sticky overflow-clip bottom-[4vh] z-40 w-11/12 h-[600px] bg-black rounded-lg border border-[#555] m-5 bg-card-gradient-blue group">
        <div className="absolute bg-grid top-0 w-full">
          <h1 className="font-fixel text-4xl font-semibold p-5 ml-4 mb-3 mt-3 heading-gradient text-left">
          ...
          <div className="z-10 flex flex-row w-full h-full gap-10 flex-wrap md:flex-nowrap">
            <div className="flex flex-col px-1 w-[80%] mt-6 ml-8 z-5 h-fit">
              <h2 className="font-medium font-fixel md:text-xl mt-4 pt-12 text-base md:leading-8">
                Selecting the perfect influencer is a breeze.
                <br />
                Utilize our powerful filtering options to pinpoint the ideal
                influencer that aligns perfectly with your needs.
              </h2>
            </div>
            <div className="relative w-full h-[549px]">
              <Image
                src="presentapp/feat-card"
          ...
          <div className="z-10 flex flex-row w-full h-full gap-10 flex-wrap md:flex-nowrap">
            <div className="flex flex-col px-1 w-[80%] mt-6 ml-8 z-5 h-fit">
              <h2 className="font-medium font-fixel md:text-xl mt-4 pt-12 text-base md:leading-8 text-[#B3B3B3]">
                Once you`ve set your budget, relax as we take care of everything
                else. From reaching out to influencers and negotiating deals to
                finalizing campaigns and more, we`ve got it all automated for
                you.
                <br />
              </h2>
              <span className="font-medium font-fixel text-lg md:text-2xl text-white pt-2">
                Sit back and watch the{" "}
                <span className="magic-text bg-gradient-to-r from-indigo-500 via-purple-400 to-pink-400 inline-block bg-clip-text text-transparent">
                  magic !
                </span>
              </span>
            </div>

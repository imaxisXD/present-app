        ...
        <div className="z-10 flex flex-row w-full h-full">
          <div className="flex flex-col items-center w-1/2 mt-6 ml-8 z-5 gap-3">
            <div className="z-50 flex flex-col items-center w-11/12 sm:h-52 h-32 gap-8 rounded-md border border-[#383838] bg-inside-card backdrop-blur-md bg-opacity-10">
              <h2 className="text-center font-medium font-fixel md:text-xl mt-4 p-2 text-base">
                Search influencer from any social media platform
              </h2>
              ...
              <span className="absolute -bottom-9 py-1 px-8 bg-[#B2F042] border border-transparent rounded-r-[10px] rounded-t-[10px] font-inter text-xl font-bold md:text-3xl text-black">
                OR
              </span>
            </div>
            <CustomCursorDiv />

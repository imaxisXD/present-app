...
export default function FeatureCard() {
    return (
        ...
        <div className="sticky bottom-[6vh] z-50 w-11/12 h-[600px] rounded-lg border bg-card-gradient-green border-[#555] m-2 ">
            <h1 className="font-fixel text-4xl font-semibold">Step 1: Search</h1>
            <div className="flex ">
                <div>
                    <div className="flex flex-col items-center w-11/12 h-56 gap-9 rounded-md border border-[#383838]">
                        <h2 className="text-center font-fixel text-2xl font-medium mt-4">Search influencer from any social media platform</h2>
                        <ParallaxText baseVelocity={3} hoverVelocity={1}>
                            <svg

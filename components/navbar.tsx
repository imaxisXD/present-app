...
export const Navbar = () => {
    ...
    return (
        <nav className="bg-[#0F1414] bg-opacity-80 backdrop-blur-md container sticky inset-x-0 top-2 mt-0 z-30 mx-auto w-screen lg:w-screen md:w-screen max-w-screen-xl py-1 px-2 border-outline-gray/[.33] md:rounded-full md:border">
